...
import { FaAddressCard, FaEdit, FaPhoneSquareAlt, FaUniversity, FaUserEdit } from 'react-icons/fa';
...
return (
    <>
        <div className='relative flex md:flex-row flex-col items-center gap-y-3  gap-x-5 justify-center'>
            ...
            <div className={`col-4 ${!openModal ? 'blur-xl' : 'blur-none'}`} >
            ...
            <div className={`col-6 ${!openModal ? 'blur-xl' : 'blur-none'}`}>
            ...
            <div className='col-2 absolute top-0 right-12 md:right-64'>
                <FaEdit onClick={() => setOpenModal(!openModal)} className='text-2xl' />
        ...
        {/* <!-- Main modal --> */}
        <div className={`bg-gray md:w-3/6 md:2/6 mx-auto rounded shadow-md relative -top-[500px] md:-top-64 ${openModal ? 'hidden' : 'block'}`}>
            <form onSubmit={handelUserUpdate} class="space-y-6 p-8" action="#">
                {/* ----------- */}
                <div className='md:flex gap-3'>
                    <fieldset className="w-full mb-5 space-y-1 dark:text-gray-100">
                        ...
                        <div className="flex">
                            <span className="flex items-center px-1 pointer-events-none sm:text-sm rounded-l-md dark:bg-gray-700"><FaUserEdit className='mr-3 text-2xl' /></span>
                            <input type="text" name="name" defaultValue={users?.userName} className="p-2 flex flex-1 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400" />
                        </div>
                    </fieldset>
                    <fieldset className="w-full space-y-1 dark:text-gray-100">
                        {/* <label for="url" className="block text-sm font-medium">University</label> */}
                        <div className="flex">
                            <span className="flex items-center px-1 pointer-events-none sm:text-sm rounded-l-md dark:bg-gray-700"><MdEmail className='mr-3 text-2xl' /></span>
                            <input type="email" name="email" id="url" defaultValue={users?.userEmail} className="p-2 flex flex-1 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400" />
                        </div>
                    </fieldset>
                </div>
                <div className='md:flex gap-3'>
                    <fieldset className="w-full mb-5 space-y-1 dark:text-gray-100">
                        {/* <label for="url" className="block text-sm font-medium">University</label> */}
                        <div className="flex">
                            <span className="flex items-center px-1 pointer-events-none sm:text-sm rounded-l-md dark:bg-gray-700"><FaUniversity className='mr-3 text-2xl' /></span>
                            <input type="text" name="education" className="p-2 flex flex-1 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400" />
                        </div>
                    </fieldset>
                    <fieldset className="w-full space-y-1 dark:text-gray-100">
                        {/* <label for="url" className="block text-sm font-medium">University</label> */}
                        <div className="flex">
                            <span className="flex items-center px-1 pointer-events-none sm:text-sm rounded-l-md dark:bg-gray-700"><FaAddressCard className='mr-3 text-2xl' /></span>
                            <input type="text" name="address" className="p-2 flex flex-1 border sm:text-sm rounded-r-md focus:ring-inset focus:ring-violet-400" />
                        </div>
                    </fieldset>
                </div>
                <div className='md:flex gap-3'>
                ...
                {/* --------- */}
                <button type="submit" class="w-full text-white bg-blue-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-800 dark:focus:ring-blue-800">Update</button>
