        ...
        <header className="mb-12 dark:bg-gray-800 dark:text-gray-100 bg-white">
            <div className="container flex justify-between h-16 mx-auto">
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    <li className="flex">
                        <Link to='/media' rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Media</Link>
                    </li>
                    <li className="flex">
                        <Link to='/massage' rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 dark:border-transparent">Massage</Link>
                    </li>
                    <li className="flex">
                        <Link to='/about' rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 dark:border-transparent">About</Link>
                    </li>
                </ul>
                <Link to='/home' rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center p-2">
                    <img className='md:mx-72' style={{width: '80px'}} src={logo} />
